...
insert into sys_parameter(guid,param_key,param_value) value ('metric_template_03','metric_template','{"name":"percent[1-a/b]","prom_expr":"100*(1-(sum($a)/sum($b) > 0 or vector(0)))","param":"$a,$b"}');
