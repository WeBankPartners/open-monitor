...
func init() {
	...
	httpHandlerFuncListV2 = append(httpHandlerFuncListV2,
		...
		&handlerFuncObj{Url: "/service/log_metric/log_monitor_template/system_params/config", Method: http.MethodGet, HandlerFunc: service.GetLogMonitorTemplateSysParamsConfig, ApiCode: "service_log_metric_log_monitor_template_sys_params_config"},
		...
		&handlerFuncObj{Url: "/service/log_metric/log_metric_group/status", Method: http.MethodPut, HandlerFunc: service.UpdateLogMetricGroupStatus, ApiCode: "service_log_metric_log_metric_group_update_status"},
