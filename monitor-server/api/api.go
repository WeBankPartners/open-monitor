...
func init() {
	...
	httpHandlerFuncList = append(httpHandlerFuncList,
		...
		&handlerFuncObj{Url: "/agent/start/:name", Method: http.MethodPost, HandlerFunc: agent.AlarmControl},
		&handlerFuncObj{Url: "/agent/stop/:name", Method: http.MethodPost, HandlerFunc: agent.AlarmControl},
