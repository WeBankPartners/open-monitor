...
export default {
  data () {
    return {
      ...
      userNameRules: [{ required: true, message: '用户名不能为空', trigger: 'blur' }],
      passwordRules: [{ required: true, message: '密码不能为空', trigger: 'blur' }],
      rePasswordRules: [{ required: true, message: '确认不能为空', trigger: 'blur' }],
      emailRules: [{ required: true, message: '邮箱不能为空', trigger: 'blur' }],
      displayNameRules: [{ required: true, message: '显示名不能为空', trigger: 'blur' }],
    }
  },
  computed: {
    rules () {
